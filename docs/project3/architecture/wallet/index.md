...
Кошелёк -- это система, состоящая из трёх сред:
1. среда приложения (Andoid, iPone, PC и т.д)
2. смарт-карта (в частном случае SIM) карта для обеспечения задач информационной безопасности.
3. часть банкнот системы процессинга, принадлежащие данному кошельку и предназначенные для online операций.
...
offline переводе
денег,
а так же обеспечивает доступ 
к online деньгам кошелька.

При взломе доверенной среды,
возможно создание поддельных банкнот
из уже существующих
в рамках offline передачи данных.
Однако в отличие от криптовалют,
даже в случае взлома смарт-карты
подделать можно только текущие банкноты на кошельке,
а не банкноты всей системы ODC.
Это делает ODCv3 безопасной системой.
...
На бизнес уровне взаимодействие можно представить следующим способом:
![Схема_кошелька.drawio.png](../../../../static/img/%D0%A1%D1%85%D0%B5%D0%BC%D0%B0_%D0%BA%D0%BE%D1%88%D0%B5%D0%BB%D1%8C%D0%BA%D0%B0.drawio.png)

**TODO КРАСИВО ПЕРЕРИСОВАТЬ**
